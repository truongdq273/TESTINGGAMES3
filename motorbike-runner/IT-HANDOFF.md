...
# Bàn giao IT — Motorbike Runner (`motorbike-runner`)
...
- Chuyển từ demo sang lớp thật: sửa đúng **một file** `lib/game-config.js`:
  ...
  ```
- Chủ nội dung vào `https://<tên-miền-máy-chủ>/admin`, đặt link nguồn cho gameId `motorbike-runner`.
...
## Nội dung game
- Luật hoạt cảnh: Mỗi câu trả lời đúng, xe máy nhảy vọt qua chướng ngại vật. Sai sẽ tông chướng ngại vật, giật lùi, kèm âm thanh tương ứng. Nền đường phố Việt Nam trượt ngang liên tục.
- Nhịp câu hỏi: `self` · Số người tối đa: `4`
- Dung lượng thư mục: 98788 byte (giới hạn 5.000.000)
